<template>
  <div
    id="navbar"
    ref="navbar"
    class="navbar bg-primary fixed top-0 w-full z-200  text-white"
  >
    <div class="container">
      <div class="wrapper flex ietms-center py-2 justify-between">
        <div class="logo flex ietms-center">
          ...
          >
            <path
              d="M511.968 24.072l-10.992-11.584-244.992 232.48L10.992 12.488 0 24.072l244.368 231.904L0 487.88l10.992 11.6L255.984 267l244.992 232.48 10.992-11.6L267.6 255.976z"
            />
          </svg>
          ...
          <svg
            ...
            style="width: 25px; fill: #fff;"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 49.23 30.78"
          >
            <path
              class="cls-1"
              d="M46.58 5.3H2.65a2.65 2.65 0 010-5.3h43.93a2.65 2.65 0 010 5.3zM46.58 18H2.65a2.65 2.65 0 110-5.3h43.93a2.65 2.65 0 010 5.3zM23.29 30.78H2.65a2.65 2.65 0 110-5.3h20.64a2.65 2.65 0 110 5.3z"
            />
          </svg>
        ...
        <div class="navbar__links flex items-center">
          ...
          <div class="nav__cart-list flex items-center">
            <span
              v-if="!loggedIn"
              class="menu__list-item px-2  uppercase rtl:mt-m4 login"
            >
              <login-modal />
            </span>
            <span
              v-if="!loggedIn"
              class="menu__list-item px-2 hidden lg:block uppercase rtl:mt-m4 login"
            >
              <register-modal />
            </span>
            <span
...
export default {
  ...
  computed: {
    ...
    menusLoading() {
      return this.$store.getters["menu/menusLoading"];
    },
  },
  ...
  methods: {
    ...
    async setLocale() {
      this.$Progress.start();
      await this.$store.dispatch("ui/toggleLocale", { i18n: this.$i18n });
